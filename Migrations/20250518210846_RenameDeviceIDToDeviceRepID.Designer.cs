...
namespace OhmZone_ProiectLicenta.Migrations
{
    ...
    [Migration("20250518210846_RenameDeviceIDToDeviceRepID")]
    partial class RenameDeviceIDToDeviceRepID
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("OhmZone_ProiectLicenta.Models.RepairGuide", b =>
                {
                    ...
                    b.HasOne("OhmZone_ProiectLicenta.Models.Device", null)
                        .WithMany("RepairGuides")
                        .HasForeignKey("DeviceId");

                    b.HasOne("OhmZone_ProiectLicenta.Models.Device", "Device")
                        .WithMany()
                        .HasForeignKey("DeviceRepID")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
